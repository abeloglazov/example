package training.mysimpleblog.i18n;
...
/**
 * Custom ReousrceBundle class, that allows to use UTF-8 encoded text in
 * internationalization properties files. Source:
 * http://jdevelopment.nl/internationalization
 * -jsf-utf8-encoded-properties-files/
 * 
 * @author Bauke Scholtz
 */
public class ResourceBundleUtf8 extends ResourceBundle {

    protected static final String BUNDLE_NAME = "training.mysimpleblog.i18n.messages";
